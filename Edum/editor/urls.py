...
urlpatterns = patterns('',
    ...
    url(r'^courses/modules/(?P<module_id>\d+)/merge_lecture/(?P<action>\w+)/(?P<lecture_id>[\d\w]+)$', 'editor.views.merge_lecture', name='merge_lecture'),
    url(r'^courses/modules/(?P<module_id>\d+)/merge_test/(?P<action>\w+)/(?P<test_id>[\d\w]+)$', 'editor.views.merge_test', name='merge_test'),
    ...
    url(r'^courses/(?P<course_id>\d+)/modules/(?P<module_id>\d+)/tests$', 'editor.views.edit_tests', name='edit_tests'),
    url(r'^courses/(?P<course_id>\d+)/modules/(?P<module_id>\d+)/tests/(?P<test_id>\d+)$', 'editor.views.edit_test', name='edit_test'),
)
