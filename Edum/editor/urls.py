...
urlpatterns = patterns('editor.views',
    ...
    url(r'^courses/modules/tests/(?P<test_id>\d+)/questions/add$', QuestionCreator.as_view(), name='add_question'),
    url(r'^courses/modules/tests/(?P<test_id>\d+)/questions/update/(?P<pk>\d+)$', QuestionUpdater.as_view(), name='update_question'),
    url(r'^courses/modules/tests/(?P<test_id>\d+)/questions/delete/(?P<pk>\d+)$', QuestionDeleter.as_view(), name='delete_question'),
    url(r'^courses/modules/tests/questions/(?P<question_id>\d+)/answers/add$', AnswerCreator.as_view(), name='add_answer'),
    url(r'^courses/modules/tests/questions/(?P<question_id>\d+)/answers/update/(?P<pk>\d+)$', AnswerUpdater.as_view(), name='update_answer'),
    url(r'^courses/modules/tests/questions/(?P<question_id>\d+)/answers/delete/(?P<pk>\d+)$', AnswerDeleter.as_view(), name='delete_answer'),
