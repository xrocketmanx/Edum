...
urlpatterns = patterns('app.views',
    ...
    url(r'^courses/(?P<course_id>\d+)/like_course$', 'like_course', name='like_course'),
    ...
    url(r'^courses/(?P<course_id>\d+)/test/(?P<test_id>\d+)$', 'start_test', name='start_test'),
    url(r'^courses/(?P<course_id>\d+)/test/(?P<test_id>\d+)/get_questions$', 'get_questions', name='get_questions'),
    url(r'^courses/(?P<course_id>\d+)/test/(?P<test_id>\d+)/get_test_result$', 'get_test_result', name='get_test_result'),
)
